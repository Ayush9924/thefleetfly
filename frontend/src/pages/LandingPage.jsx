    ...
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          >
            Fleet<span className="text-gray-900">Pro</span>
          </motion.div>
          <Button 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-10 leading-relaxed max-w-2xl">
              The only fleet management platform you need. Real-time tracking, intelligent analytics, 
              and seamless operations—all in one powerful dashboard.
            </p>
            ...
            <div className="flex items-center mt-12 space-x-8">
              <div className="flex -space-x-3">
                {[1,2,3,4].map((i) => (
                  <div key={i} className="w-10 h-10 rounded-full bg-linear-to-r from-blue-400 to-indigo-400 border-2 border-white"></div>
                ))}
              </div>
              <div>
                <p className="text-sm font-semibold text-gray-900">Join 2,500+ companies</p>
                <p className="text-sm text-gray-500">already optimizing their fleets</p>
              </div>
            </div>
          </motion.div>
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-gray-200/50">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm font-medium text-gray-900">Delivery Route #45678</span>
                    </div>
                    <span className="text-xs bg-green-100 text-green-800 px-2 py-1 rounded-full">On Time</span>
                  </div>
                  <div className="flex items-center">
                    <MapPin className="w-4 h-4 text-gray-500 mr-2" />
                    <span className="text-xs text-gray-600">Warehouse A → Downtown → Airport</span>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From vehicle tracking to driver management, we've built the complete solution 
          ...
          >
            {[
              ...
              },
              {
                ...
                description: 'Monitor driver behavior, assign routes efficiently, and track performance metrics.'
              },
              {
                icon: <BarChart3 className="w-8 h-8" />,
                title: 'Advanced Analytics Dashboard',
                description: 'Custom reports on fuel efficiency, cost per mile, and operational insights.'
              },
              {
              ...
              },
              {
                ...
                description: 'Stay informed with live alerts and comprehensive fleet visibility.'
              },
              {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative">
          ...
          >
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Join thousands of companies who have transformed their fleet operations with our platform.
            </p>
          </motion.div>
          ...
          <div className="mt-16 flex justify-center">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 max-w-4xl">
              ...
              <p className="text-blue-100 text-lg italic">
                "FleetPro reduced our fuel costs by 23% and improved delivery efficiency by 35% in just three months."
              </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-10">
            Join thousands of companies already optimizing their fleet operations with our powerful platform.
          </p>
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
            <Button 
              onClick={() => navigate('/login')}
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-400 mb-6 max-w-md">
                The ultimate fleet management solution for modern businesses. Simplify operations, 
                reduce costs, and maximize efficiency.
              </p>
              <div className="flex space-x-4">
                {['twitter', 'linkedin', 'facebook', 'instagram'].map((social) => (
                  <div key={social} className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gray-700 transition-colors duration-300 cursor-pointer">
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">&copy; 2025 FleetPro. All rights reserved.</p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              {['Privacy Policy', 'Terms of Service', 'Cookie Policy'].map((item) => (
                <a key={item} href="#" className="text-gray-400 hover:text-white text-sm transition-colors duration-300">{item}</a>
              ))}
            </div>
          </div>
        </div>
